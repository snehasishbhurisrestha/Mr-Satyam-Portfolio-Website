            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('graphic-design.index') }}">Graphic Designing</a></li>
                        <li><a href="{{ route('project-motion-graphic.index') }}">Motion Graphic</a></li>
                        <li><a href="{{ route('video-production.index') }}">Video Production</a></li>
                        <li><a href="{{ route('project-cgi.index') }}">CGI</a></li>
                    </ul>
                </li>

                <li>
                    <a href="{{ route('our-client.create') }}" class=" waves-effect">
                ...
                <li>
                    <a href="{{ route('banner.create') }}" class=" waves-effect">
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="email-inbox.html">Service Category</a></li>
                        <li><a href="email-read.html">Service List</a></li>
                    </ul>
                </li> --}}

                {{-- <li>
                    <a href="{{ route('gallerys.index') }}" class=" waves-effect">
                ...
                {{-- <li>
                    <a href="{{ route('appoinments.index') }}" class=" waves-effect">
