...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Add new Project Video Production</li>
            </ol>
         </div>
         <div class="col-md-4">
   ...
   <form action="{{ route('video-production.store') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="row">
         <div class="col-lg-9">
            <div class="card">
               <div class="card-header bg-primary text-light">
                  Add New Project Video Production
               </div>
               <div class="card-body">
