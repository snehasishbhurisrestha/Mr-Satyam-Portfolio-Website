...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item"><a href="{{ route('video-production.index') }}">Project Video Production</a></li>
               <li class="breadcrumb-item active" aria-current="page">Edit Project Video Production</li>
            </ol>
         </div>
         <div class="col-md-4">
            <div class="float-end d-none d-md-block">
               <div class="dropdown">
                  <a href="{{ route('video-production.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
   ...
   <form action="{{ route('video-production.update',$project->id) }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row">
         <div class="col-lg-9">
               ...
               <div class="card-body">
                  ...
                  <div class="mb-3" id="parent-design" style="display: block;">
                     ...
                     <select class="select2 form-control" name="parent_id" data-placeholder="Choose ...">
                        ...
                        @foreach($video_production as $project_motion_graphic)
                         <option value="{{ $project_motion_graphic->id }}" @if($project->parent_id == $project_motion_graphic->id) selected @endif>{{ $project_motion_graphic->name }}</option>
                         @endforeach
                     </select>
                 </div>
         ...
         <div class="col-lg-3">
            <div class="card" id="parent-image" style="display: none;">
               ...
               <div class="card-body text-center">
                     <div class="mb-2">
                        <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200" src="{{ $project->getFirstMediaUrl('project-video-production') }}" data-holder-rendered="true" style="display: {{ is_have_image($project->getFirstMediaUrl('project-video-production')) }};">
                     </div>
                     <div class="mb-0">
            ...
            <div class="card" id="details-page-image" style="display: none;">
               ...
               <div class="card-body text-center">
                     <div class="mb-2">
                        <img class="img-thumbnail rounded me-2" id="blah2" alt="" width="200" src="{{ $project->getFirstMediaUrl('project-video-production-details') }}" data-holder-rendered="true" style="display: {{ is_have_image($project->getFirstMediaUrl('project-video-production-details')) }};">
                     </div>
                     <div class="mb-0">
