      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-4">
            <div class="float-end d-none d-md-block">
               <div class="dropdown">
                  <a href="{{ route('testimonial.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
               ...
               <div class="card-body">
                  <div class="mb-3">
                     ...
                     <div>
                        <input data-parsley-type="text" type="text"
                           ...
                           placeholder="Enter Name" name="name" value="{{ $testimonial->name }}" id="name">
                     </div>
                  </div>
                  ...
                  <div class="mb-3">
                     ...
                     <div>
                        <input data-parsley-type="text" type="text"
                           class="form-control" required
                           placeholder="Enter Address" name="address" value="{{ $testimonial->address }}" id="title">
                     </div>
                  </div>
                  ...
                  <div class="mb-3">
                     ...
                     <div>
                        <textarea name="description"  class="form-control editor" rows="5">{{ $testimonial->description }}</textarea>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="col-lg-3">
            <div class="card">
               ...
               <div class="card-body text-center">
                     <div class="mb-2">
                        <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200" src="{{ $testimonial->getFirstMediaUrl('testimonial-image') }}" data-holder-rendered="true" style="display: {{ is_have_image($testimonial->getFirstMediaUrl('testimonial-image')) }};">
                     </div>
                     <div class="mb-0">
                  ...
                  <div class="card-body">
                     <div class="mb-3">
                        ...
                        <div class="rating-star">
                           <input type="hidden" class="rating" name="rating" value="{{ $testimonial->rating }}" data-filled="mdi mdi-star text-primary" data-empty="mdi mdi-star-outline text-muted" required/>
                        </div>
                     </div>
                     <div class="mb-3">
