                        ...
                        <div class="tab-pane active p-3" id="basicinfo" role="tabpanel">
                            <div class="card-body row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <div>
                                        <textarea class="editor" name="sort_description"></textarea>
                                    </div>    
                                </div>
                                <div class="mb-3 col-md-12">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" id="is_special1" name="is_special" class="form-check-input" value="1" checked>
                            <label class="form-check-label" for="is_special1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="is_special2" name="is_special" class="form-check-input" value="0">
