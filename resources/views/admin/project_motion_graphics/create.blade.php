...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item"><a href="{{ route('project-motion-graphic.index') }}">Project Motion Graphics</a></li>
               <li class="breadcrumb-item active" aria-current="page">Add new Project Motion Graphics</li>
            </ol>
         </div>
         <div class="col-md-4">
            <div class="float-end d-none d-md-block">
               <div class="dropdown">
                  <a href="{{ route('project-motion-graphic.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
   ...
   <form action="{{ route('project-motion-graphic.store') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="row">
         <div class="col-lg-9">
            <div class="card">
               <div class="card-header bg-primary text-light">
                  Add New Project Motion Graphics
               </div>
               <div class="card-body">
                  <div class="mb-3 text-center">
                     <div class="form-check form-check-inline">
                        <input type="radio" id="parent_child1" name="parent_child" class="form-check-input" value="1">
                        <label class="form-check-label" for="parent_child1">Add Parent</label>
                     </div>
                     <div class="form-check form-check-inline">
                        <input type="radio" id="parent_child2" name="parent_child" class="form-check-input" value="0" checked>
                        <label class="form-check-label" for="parent_child2">Add Child</label>
                     </div>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3" id="parent-design" style="display: block;">
                     ...
                     <select class="select2 form-control" name="parent_id" data-placeholder="Choose ...">
                        ...
                        @foreach($project_motion_graphics as $project_motion_graphic)
                         <option value="{{ $project_motion_graphic->id }}">{{ $project_motion_graphic->name }}</option>
                         @endforeach
                     </select>
                 </div>
