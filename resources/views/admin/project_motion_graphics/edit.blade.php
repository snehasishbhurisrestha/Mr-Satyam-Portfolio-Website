...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Edit Project Motion Graphics</li>
            </ol>
         </div>
         <div class="col-md-4">
   ...
   <form action="{{ route('project-motion-graphic.update',$project->id) }}" method="post" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row">
         <div class="col-lg-9">
