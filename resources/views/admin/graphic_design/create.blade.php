...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Add New Graphic Design</li>
            </ol>
         </div>
         <div class="col-md-4">
   ...
   <form action="{{ route('graphic-design.store') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="row">
         <div class="col-lg-9">
            <div class="card">
                  ...
                  <div class="mb-3">
                     ...
                     <div>
                        <input data-parsley-type="text" type="text"
                           ...
                           placeholder="Enter title" name="name" id="name">
                     </div>
                  </div>
                  <div class="mb-3">
                     ...
                     <select class="select2 form-control" name="graphic_designs_id" data-placeholder="Choose ...">
                        ...
                        @foreach($GraphicDesigns as $GraphicDesign)
                         <option value="{{ $GraphicDesign->id }}">{{ $GraphicDesign->name }}</option>
                         @endforeach
                     </select>
                 </div>
