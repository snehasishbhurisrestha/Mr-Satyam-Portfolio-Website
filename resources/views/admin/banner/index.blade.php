      ...
      <div class="row align-items-center">
         ...
         {{-- <div class="col-md-4">
            <div class="float-end d-none d-md-block">
               <div class="dropdown">
                  <a href="{{ route('banner.index') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-2">
                                    <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200" src="@if (!is_null($client)) {{ $client->getFirstMediaUrl('banner-laptop') ?? '' }} @endif" data-holder-rendered="true" style="display: @if (!is_null($client)) {{ is_have_image($client->getFirstMediaUrl('banner-laptop')) ?? '' }} @endif;">
                                </div>
                                <div class="mb-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-2">
                                    <img class="img-thumbnail rounded me-2" id="blah2" alt="" width="200" src="@if (!is_null($client)) {{ $client->getFirstMediaUrl('banner-mobile') ?? '' }} @endif" data-holder-rendered="true" style="display: @if (!is_null($client)) {{ is_have_image($client->getFirstMediaUrl('banner-mobile')) ?? '' }} @endif;">
                                </div>
                                <div class="mb-0">
