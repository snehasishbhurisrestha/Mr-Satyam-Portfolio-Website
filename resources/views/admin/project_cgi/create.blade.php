...
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Add new CGI Projects</li>
            </ol>
         </div>
         <div class="col-md-4">
   ...
   <form action="{{ route('project-cgi.store') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="row">
         <div class="col-lg-9">
            <div class="card">
                  ...
                  <div class="mb-3" id="parent-design" style="display: block;">
                     ...
                     <select class="select2 form-control" name="parent_id" data-placeholder="Choose ...">
                        ...
                        @foreach($projectcgis as $projectcgis)
                         <option value="{{ $projectcgis->id }}">{{ $projectcgis->name }}</option>
                         @endforeach
                     </select>
                 </div>
